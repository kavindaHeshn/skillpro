...
<head>
    ...
    <title>Staff - SkillPro Institute</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .staff-hero h2 { font-size: 3.2em; margin-bottom: 20px; }
        ...
        /* Footer - Same updated style with background image */
        footer {
            background: linear-gradient(rgba(0, 0, 0, 0.65), rgba(0, 0, 0, 0.75)),
                        url('../photo/footer.png'); /* Use your footer background image */
            background-size: cover;
            background-position: center;
...
<body>
    ...
    <section id="staff-content">
        <div class="container">
            ...
            <p class="staff-intro">
                At SkillPro Institute, our success is driven by a team of highly qualified and passionate instructors, 
                administrators, and support staff. With decades of combined industry experience, our staff members are 
                committed to delivering practical, high-quality training that prepares students for real-world success.
            </p>

            <div class="staff-grid">
                <!-- Staff Member 1 -->
                <div class="staff-card">
                    <img src="../photo/staff1.png" alt="Dr. Nimal Perera">
                    <div class="staff-info">
                        <h3>Dr. Nimal Perera</h3>
                        <div class="position">Director / Principal</div>
                        <p>PhD in Technical Education with over 25 years of experience in TVET sector leadership and curriculum development.</p>
                ...
                <!-- Staff Member 2 -->
                <div class="staff-card">
                    <img src="../photo/staff2.png" alt="Ms. Kumari Silva">
                    <div class="staff-info">
                        <h3>Ms. Kumari Silva</h3>
                        <div class="position">Head of ICT Department</div>
                        <p>MSc in Computer Science, Cisco Certified, 15+ years teaching programming, networking and cybersecurity.</p>
                        <div class="staff-social">
                            <a href="#" aria-label="LinkedIn"><i class="fab fa-linkedin-in"></i></a>
                            <a href="#" aria-label="Email"><i class="fas fa-envelope"></i></a>
                        </div>
                ...
                <!-- Staff Member 3 -->
                <div class="staff-card">
                    <img src="../photo/staff3.png" alt="Mr. Sunil Fernando">
                    <div class="staff-info">
                        <h3>Mr. Sunil Fernando</h3>
                        <div class="position">Senior Instructor - Automobile Technology</div>
                        <p>NVQ Level 6 qualified, 20 years industry experience in vehicle diagnostics and modern automotive systems.</p>
                        <div class="staff-social">
                            <a href="#" aria-label="LinkedIn"><i class="fab fa-linkedin-in"></i></a>
                            <a href="#" aria-label="Email"><i class="fas fa-envelope"></i></a>
                        </div>
                ...
                <!-- Staff Member 4 -->
                <div class="staff-card">
                    <img src="../photo/staff4.png" alt="Mrs. Anoma Jayasinghe">
                    <div class="staff-info">
                        <h3>Mrs. Anoma Jayasinghe</h3>
                        <div class="position">Head of Hospitality & Tourism</div>
                        <p>Diploma in Hotel Management, former Hotel Operations Manager with 18 years in tourism industry.</p>
                        <div class="staff-social">
                            <a href="#" aria-label="LinkedIn"><i class="fab fa-linkedin-in"></i></a>
                            <a href="#" aria-label="Email"><i class="fas fa-envelope"></i></a>
                        </div>
